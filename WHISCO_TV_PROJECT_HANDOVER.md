...
*Last updated: 2026-09-02-b (MILESTONE: iOS app SUBMITTED FOR APP STORE REVIEW at 08:05 UTC — reviewSubmission c80e30c4 state WAITING_FOR_REVIEW, version 1.0 build 5; 6 iPhone 6.7" + 6 iPad 12.9" screenshots uploaded via API; App Privacy published by user = Data Not Collected; contentRights = third-party; pricing Free/175 territories; review contact +973 3930 3973. Expected verdict in 24-48h. Also today: Filmhub phone invitation received; standing-PAT policy; billing ledger + monthly reminder live; Neon ~$10 audited correct. Previous: 2026-09-01 INCIDENT RESOLVED: 15:42 UTC uptime-monitor failure was a GitHub-runner DNS blip (curl exit 6), site never down — monitor hardened with 3x retry + DoH DNS cross-check + mobile API v1 endpoints now monitored; 26 closed-testing testers active; iOS: BUILD SUCCEEDED — signed .ipa on EAS (build 563ed5f9, buildNumber 5); cert 3D2AQ39PD3 + profile GJ7634S5R8 + bundleId CGDK5D6GU4 all created via ASC API key B279KL3Y3K (p8 in /home/user/.keys, gitignored); LOCAL credentials source (credentials.json + credentials/ in whisco-mobile, gitignored); TESTFLIGHT LIVE + APP STORE REVIEW SUBMITTED 2026-09-02: ascAppId 6807647992, build 1.0.0 (5), reviewSubmission c80e30c4 WAITING_FOR_REVIEW; listing fully configured via ASC API — screenshots APP_IPHONE_67 set 9a3b403e (6 shots, user's iPhone-15 captures upscaled 1290x2796, TestFlight breadcrumb masked) + APP_IPAD_PRO_3GEN_129 set 4c78d360 (6 shots, blurred-backdrop composition 2048x2732); en-US localization 9c11b4d6; age rating 12+; privacy = Data Not Collected (published by user in browser — API cannot do this step); ON APPROVAL: app goes live automatically (no manual release step configured)). Purpose: allow any future conversation/agent to resume this project with zero context loss. Read fully before acting.*
