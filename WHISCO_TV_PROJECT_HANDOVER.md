...
*Last updated: 2026-09-09 (GSC API ACCESS LIVE: service account whisco-agent@dulcet-record-441513-s1.iam.gserviceaccount.com, key at .keys/gsc-service-account.json, Full on both properties. First pull: 145 clicks/1,122 impressions 14d, brand query 'whisco tv' dominates (108c), sitemap 2,718 URLs zero errors downloaded daily. KEY FINDING: 3 newest guides + /new 'unknown to Google' (never crawled) → AdSense re-review PUSHED to Sept 17-19, green light = all guides show indexed via daily URL-inspection checks; priority IndexNow ping sent. Filmhub call RESCHEDULED to Thu Sept 17 22:00 Google Meet (reschedule form filled: partnerships@, W.L.L. name, launch answer, 100-300 title ask). Apple: day-7 inquiry sent Sep 8, case 102956986441, silence until day 14 = Sep 16. Play: day 9/14; Play Developer API linking in progress (Settings → API access, project dulcet-record-441513-s1). Vercel token live: 358 visitors/1,837 views Sep 3-8. Previous: 2026-09-08 AdSense sweep, 8 exploitation titles deleted.)*
