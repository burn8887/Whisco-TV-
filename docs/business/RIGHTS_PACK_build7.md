# RIGHTS PACK — iOS BUILD 7
**Rewritten 2026-09-17 for build 7 (uploaded to App Store Connect 2026-09-17 05:18 PT, submitted for review 2026-09-17 23:43 UTC). Content is unchanged from the build-6 pack because the catalogue is unchanged; only the build label differs. Updated 2026-09-18 to match the binary actually under review. This describes 8 live channels and 8 public-domain films — nothing else.**
