...
- **AdSense (G1)**: re-review request window **17–19 Sep**, GATED on 4 guides + /new still "unknown to Google" (check DAILY via URL Inspection API, siteUrl `https://www.whisco.tv/`). If still unindexed by 17th, flag slip to founder — don't force it.
